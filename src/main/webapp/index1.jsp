				...
				<!--notification start-->
					...
					<div class="notify-w3ls">
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="#">Tushar Yadav</a></span> send you a mail </li>
						...
						<div class="alert alert-danger">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="#">Kedar Padalkar</a></span> mentioned you in a post </li>
									<li class="pull-right notification-time">7 Hours Ago</li>
								</ul>
								<p>
									Very cool photo Tushar
								</p>
							</div>
						</div>
						<div class="alert alert-success ">
							...
							<div class="notification-info">
								...
								<p>
									<a href="#">Sanket Ilake, Ashitosh Utture</a> and <a href="#">3 others</a>
								</p>
							</div>
						</div>
						...
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="#">Satyajeet Kondekar</a></span> send you a mail </li>
									<li class="pull-right notification-time">1 min ago</li>
								</ul>
								<p>
									Urgent meeting for next proposal
