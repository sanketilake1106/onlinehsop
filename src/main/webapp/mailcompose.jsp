                ...
                <section class="panel">
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked labels-info ">
                            ...
                            <li> <a href="#"> <i class="fa fa-comments-o text-success"></i>Tushar Yadav <p>I do not think</p></a>  </li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-danger"></i>Sanket <p>Busy with coding</p></a> </li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-muted "></i> Kedar Padalakar <p>I out of control</p></a></li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-muted "></i> Ashu Utture <p>I am not here</p></a></li>
                            <li> <a href="#"> <i class="fa fa-comments-o text-muted "></i> Satyajeet <p>I do not think</p></a>  </li>
                        </ul>
                        <a href="#"> + Add More</a>
